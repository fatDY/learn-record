...
//Hierholzer 算法Hierholzer 算法用于在连通图中寻找欧拉路径，其流程如下：
//
//从起点出发，进行深度优先搜索。
//
...
//著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
    ...
    public static void main(String[] args) {
        ...
        test.add(Arrays.asList("JFK","SFO"));
        test.add(Arrays.asList("JFK","ATL"));
        test.add(Arrays.asList("SFO","ATL"));
        test.add(Arrays.asList("ATL","JFK"));
        test.add(Arrays.asList("ATL","SFO"));
        List<String> itinerary = solution332.findItinerary(test);
